   ...
   return (
      <div>
         ...
         <section
            ...
            id="page-hero"
         >
            <div className="overlay-photo-image-bg"></div>
                        ...
                        <div className="row">
                           ...
                           <div className="col-10">
                              <p className="hero-subtitle">
                                 Turtltech provides a full range of business
                                 consulting & advisory services to small,
                                 medium, and international companies worldwide.
                                 We use innovations and experience to your
                                 success.
                              </p>
                           </div>
                           <div className="col-12">
         ...
         <section
            className="services services-boxed mega-section bg-light"
            id="services"
         >
            <div className="container">
                  ...
                  <div className="row">
                     ...
                     >
                        <div className="text-area">
                           <div className="sec-heading light-title">
                              <div className="content-area">
                                 ...
                                 <h2
                                    ...
                                    data-wow-delay=".4s"
                                 >
                                    <span className="hollow-text"> What </span>
                                    <span className="featured-text">
                                       WE DO
                                       <svg
                                          xmlns="http://www.w3.org/2000/svg"
                           ...
                           <p className="about-text">
                              Your safety is our responsibility Yes, you rely on
                              us. Founded in 2022, Turtl Cyber Security aims to
                              serve you with out standing security amenities for
                              both busniess and personal domains. Our team is
                              well experienced and authentic in terms of your
                              data security and confidentiality. Be it
                              passwords, emails, websites personal and business
                              accounts or your system as a whole, we ensure to
                              provide you the best security.
                           </p>
                           <div className="info-items-list">
                              <div className="row">
                                 <div className="col-12">
                                    <div className="info-item">
                                       ...
                                       <div className="info-content">
                                          ...
                                          <p className="info-text">
                                             ...
                                             repellendus minima reiciendis nobis
                                             dolore obcaecati.
                                          </p>
                                       </div>
                                    </div>
         ...
         <section
            className="stats js-stats-counter mega-section"
         ...
         >
            ...
            ></div>
            <div className="container">
               <div className="stats-inner text-start">
                  <h1>Certificates</h1>
                  <div className="row">
                     {certificates.map((el, i) => (
                        <div
                           className="col-12 col-md-6 col-lg-3 stat-box"
                           key={el._id}
                        >
                           <div
            ...
            <div className="container">
               <div className="sec-heading">
                  <div className="content-area">
                     ...
                     <h2 className="title wow fadeInUp" data-wow-delay=".4s">
                        IT <span className="hollow-text">Services</span>
                     </h2>
                  </div>
                  <div className="cta-area wow fadeInUp" data-wow-delay=".8s">
                     <Link className="cta-btn btn-solid" to="/services">
                        see more <i className="bi bi-arrow-right icon"></i>
                     </Link>
                  </div>
               </div>
               <Tabs
            ...
            <div className="container">
               <div className="sec-heading">
                  <div className="content-area">
                     ...
                     <h2 className="title wow fadeInUp" data-wow-delay=".4s">
                        latest <span className="hollow-text">news</span>
                     </h2>
                  </div>
                  <div
